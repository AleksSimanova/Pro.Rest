...
public class PutUser_Test {
    ...
    @Test
    //Провека работоспособности сменытименни user с авторизацией
    public void updateUser() {
        String nameOld = "name";
        while (petStoreApi.getUserForName(nameOld).statusCode(200).equals(true)) {
            petStoreApi.deleteUser(nameOld);
        }
